...
.PHONY: all asan test test-idat test-betas test-prep test-qmask test-poobah test-noob test-batch test-qc test-dml test-cg test-attach test-cnv test-cbs test-vcf index cnv-normals yame-lib install fuzz fuzz-replay clean
...
test: test-idat test-betas test-prep test-qmask test-poobah test-noob test-batch test-qc test-dml test-cg test-attach test-cnv test-cbs test-vcf
